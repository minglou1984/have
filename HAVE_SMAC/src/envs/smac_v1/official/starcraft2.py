...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.shield_bits_ally = 1 if self._agent_race == "P" else 0 # modified 1
        self.shield_bits_enemy = 1 if self._bot_race == "P" else 0 # 1
        self.unit_type_bits = map_params["unit_type_bits"] # 3
        ...
        self.ally_state_attr_names = [ # distance, visible
            "health",
            "energy/cooldown",
            "rel_x",
            "rel_y",
        ]
        self.enemy_state_attr_names = ["health", "rel_x", "rel_y"] # distance, visible
    ...
    def get_state(self):
        ...
        """
        ##########################
        return np.array(self.get_obs()).reshape(1,-1) # for get joint obs
        ##########################
    ...
    def get_state_size(self):
        ...
        ##########################
        return self.get_obs_size() * self.n_agents # for joint obs
        ##########################
        # if self.obs_instead_of_state:
