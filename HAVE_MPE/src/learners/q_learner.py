...
class QLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        print('Agent Size: ', get_parameters_num(list(self.mac.parameters())))
        print('Mixer Size: ', get_parameters_num(list(self.mixer.parameters())))
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if self.args.target_update_interval_or_tau > 1 and (self.training_steps - self.last_target_update_step) / self.args.target_update_interval_or_tau >= 1.0:
            ...
            self.last_target_update_step = self.training_steps # self.training_steps
