...
_particles = {
    ...
    "cooperative_navigation": "CooperativeNavigation-v0",
    "predator_prey": "PredatorPrey-v0"
}

# for scenario_name, gymkey in _particles.items():
#     scenario_module = importlib.import_module("envs.mpe.mpe.scenarios." + scenario_name)
#     print(id(scenario_module))
...
#             "info_callback": getattr(scenario_aux, "benchmark_data", None),
