import importlib
from .environment import MultiAgentEnv as MPEMultiAgentEnv
...
class MPEWrapper(MultiAgentEnv):
    def __init__(self, key, time_limit, **kwargs):
        ...
        world = scenario.make_world(
            ...
            num_agents_obs=kwargs["n_allies"],
            num_landmarks_obs=kwargs["n_enemies"],
        )
        ...
        env = MPEMultiAgentEnv(
            ...
            info_callback=getattr(scenario, "benchmark_data", None),
        )
        ...
        self.n_allies = kwargs["n_allies"]
        self.n_enemies = kwargs["n_enemies"]
        self.own_feats_dim = kwargs["own_feats_dim"]
        self.ally_feats_dim = kwargs["ally_feats_dim"]
        self.enemy_feats_dim = kwargs["enemy_feats_dim"]
    ...
    def step(self, actions, animate=False):
        ...
        return float(reward[0]), all(done), info['n'][0]
    ...
    def get_prey_positions(self):
        return [p.state.p_pos for p in self._env.world.preys]
    ...
    def get_obs_component(self, n_allies, n_enemies):
        own_feats_dim = self.own_feats_dim
        ally_feats_dim = self.ally_feats_dim
        enemy_feats_dim = self.enemy_feats_dim

        ally = [n_allies, ally_feats_dim]
        enemy = [n_enemies, enemy_feats_dim]
        obs_component = [own_feats_dim, ally, enemy]
    ...
    def get_env_info(self):
        env_info = {
            ...
            "obs_component": self.get_obs_component(self.n_allies, self.n_enemies)
        }
        return env_info